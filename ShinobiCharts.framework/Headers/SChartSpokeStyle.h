...
/** `SChartSpokeStyle` manages the appearance of spokes for `SChartDonutSeries` and `SChartPieSeries` objects.
 ...
 Spokes can be enabled on a per-slice basis. Please see our [user guide](labels-and-legends.html#pie-and-donut-series) for a code sample.
 */
 
@interface SChartSpokeStyle : NSObject <NSCopying>

#pragma mark - Spoke Properties 
...
#pragma mark - Anchor Circle Properties 
