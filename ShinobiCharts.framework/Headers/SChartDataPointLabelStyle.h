...
/** Whether an `SChartDataPointLabal` should the display x and y values, or both, of an `SChartDataPoint`.
...
/** The direction the text of an `SChartDataPointLabel` should be displayed. Defaults to `SChartDataPointLabelOrientationHorizontal`.
...
/** The z-position in the data where an `SChartDataPointLabel` should be placed. Defaults to `SChartDataPointLabelPositionBelowData`
