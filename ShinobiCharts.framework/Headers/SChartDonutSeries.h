...
/** The direction in which data is drawn around the centre of the plot of an `SChartDonutSeries`.
 
 - `SChartRadialSeriesDrawDirectionClockwise`: Draws the data in a clockwise direction around the center of the plot.
 - `SChartRadialSeriesDrawDirectionAntiClockwise`: Draws the data in a anticlockwise direction around the center of the plot.
 */
...
/** Sets the style object for the scatter series when it is selected.
 ...
 @see `SChartDonutSeries.selectedStyle`
 */
