...
/**
 `ShinobiChart` now offers you the option of loading data asynchronously.  If data is loading in the background, the chart displays an activity indicator while the data is being loaded.  The indicator can optionally adopt the `SChartActivityIndicator` protocol.
