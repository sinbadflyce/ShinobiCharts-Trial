...
/**
 The z-position of an annotation with respect to the chart's data

 - `SChartAnnotationAboveData` Configures the annotation to be drawn in front of the chart data.
 - `SChartAnnotationBelowData` Configures the annotation to be drawn underneath the chart data.
 */
...
/** An `SChartAnnotation` is a `UIView` that can be displayed on a chart - maintaining aspect ratio at all times and position in accordance with the panning of the data range (see below). 
 ...
 More information about using `SChartAnnotation` can be found in the [user guide](annotations.html)
