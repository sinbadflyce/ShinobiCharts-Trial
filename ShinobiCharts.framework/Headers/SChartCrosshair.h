...
/** Defines whether a crosshair is in floating mode or not.
 
 - `SChartCrosshairModeSingleSeries` The crosshair will lock to a single series, and display on the closest data point in that series only.
 - `SChartCrosshairModeFloating` The crosshair will display on the closest data point.
 */
...
/** Defines the behavior of a crosshair when it goes out of range.
...
- `SChartCrosshairOutOfRangeBehaviorKeepAtEdge` The crosshair will move along the edge of the canvas until the series comes back into range
- `SChartCrosshairOutOfRangeBehaviorHide` The crosshair will hide, but continue to track the series until it comes back in range.
- `SChartCrosshairOutOfRangeBehaviorRemove` The crosshair will remove itself entirely, leaving the chart open for panning or tracking a new series.
