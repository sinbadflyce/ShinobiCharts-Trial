...
```
 ...
 More information about using SChartTheme can be found in the [user guide](styling-a-chart.html#themes).

 @see `SChartiOS7Theme` <br/> `SChartLightTheme` <br/> `SChartDarkTheme`
 */
