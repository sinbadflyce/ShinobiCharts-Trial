...
/** Baseline for the series, on the x or y axis depending on its orientation.
 ...
 The default values for the property depend on the series type:
 
  - For bar/column series and stacked series, the default baseline is `0.0` (or `1.0` for logarithmic axes)
  - For other series, the default baseline is the minimum of the axis's default range
