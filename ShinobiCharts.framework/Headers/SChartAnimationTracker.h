...
/**
 A block to be executed on completion of an animation.

 @param finished indicates whether or not the animations actually finished before the completion handler was called
 */
